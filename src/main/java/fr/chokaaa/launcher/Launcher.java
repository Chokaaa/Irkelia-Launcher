...
import fr.chokaaa.launcher.ui.panels.pages.Login;
...
public class Launcher extends Application {
    ...
    private final File launcherDir = Helpers.generatGamePath(".Irkelia");
    private final Saver saver;
    private AuthProfile authProfile = null;

    public Launcher() {
        instance = this;
        this.logger = new Logger("[Irkelia]", new File(this.launcherDir, "launcher.log"));
